...
# V2 adding maximal steps for pacman
from util import *
import time
import traceback
import sys
...
class Game:
    ...
    def run(self):
        ...
        while not self.gameOver:
            ...
            if self.catchExceptions:
                try:
                    if self.numMoves >= self.max_pac_steps:
                        self.state = self.state.generateSuccessor(agentIndex, action, kill=True)
                        print("Reached Maximal Amount of steps for pacman. Killing him ")
