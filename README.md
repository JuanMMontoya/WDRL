...
<object data="https://github.com/JuanMMontoya/media/WDRL.pdf" type="application/pdf" width="700px" height="700px">
    <embed src="https://github.com/JuanMMontoya/media/WDRL.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="https://github.com/JuanMMontoya/media/WDRL.pdf">Download PDF</a>.</p>
    </embed>
</object>
...
Where the program runs on the medium map, evaluating the model for 100 games, using the directional ghoths and the WDQN algoritm with 3 features. To guarantee replication 
